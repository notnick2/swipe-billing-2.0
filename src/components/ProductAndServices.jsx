...
return (
    ...
    <div className="bg-white shadow rounded-lg h-full">
        ...
        <div className="grid grid-cols-2 gap-8 pr-[200px] pl-[150px] pt-10">
            ...
            <div className=''>
            <h3 className="text-2xl font-bold mb-4 pb-1">Organize and streamline all your products.</h3>
            <p className="text-gray-600 mb-4 pb-1">Flexibility to manage your products and services using features like bulk upload, batching, and price lists.</p>
