...
function PurchaseOrders() {
  ...
  const features = [
   "Convert your Purchase Order to purchase invoices",
   "Facilitating transparent & smooth transactions",
   "Streamline the purchase invoicing process by issuing Purchase Orders",
  ];
      ...
      <div className="bg-white shadow rounded-lg h-full">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="grid grid-cols-2 gap-8 pr-[200px] pl-[150px] pt-10">
            ...
            <div className=''>
              <h3 className="text-2xl font-bold mb-4 pb-1">Purchase Orders with a touch of magic.</h3>
              <p className="text-gray-600 mb-4 pb-1">Turn Purchase Orders into invoices for better purchasing efficiency.</p>
