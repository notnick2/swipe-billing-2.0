...
return (
    ...
    <div className="bg-white shadow rounded-lg h-full">
        ...
        <div className="grid grid-cols-2 gap-8 pr-[200px] pl-[150px] pt-10">
            ...
            <div className=''>
            <h3 className="text-2xl font-bold mb-4 pb-1">manage settlements</h3>
            <p className="text-gray-600 mb-4 pb-1">manage transactions and payouts at one plae and search transactions</p>
            ...
            <Link className="bg-[#FFD30E] hover:border-[#ffd518] text-white font-bold py-2 px-4 rounded" to = {'/bfeedback'}>
                Upgrade 🚀
            </Link>
