      ...
      <div className="bg-white shadow rounded-lg h-full">
        <div className="px-4 py-5 sm:p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Pro Forma Invoices</h2>
          ...
          <div className="grid grid-cols-2 gap-8 pr-[200px] pl-[150px] pt-10">
            ...
            <div className=''>
              <h3 className="text-2xl font-bold mb-4 pb-1">Pro Forma Invoices Made Easy.</h3>
              <p className="text-gray-600 mb-4 pb-1">Convert pro forma invoices to sales invoices for transparent, efficient transactions.</p>
