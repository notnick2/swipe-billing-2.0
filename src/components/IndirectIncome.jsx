...
function IndirectIncome() {

const features = [
    "Organize your indirect income into categories",
    "Enhance the financial accuracy of your business",
    "Get better insights to your business"
];
...
return (
    ...
    <div className="bg-white shadow rounded-lg h-full">
        ...
        <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Indirect Income</h2>
        ...
        <div className="grid grid-cols-2 gap-8 pr-[200px] pl-[150px] pt-10">
            ...
            <div className=''>
            <h3 className="text-2xl font-bold mb-4 pb-1">Track income from sources other than your main business.</h3>
            <p className="text-gray-600 mb-4 pb-1">Organise indirect income for accurate finances and gain better insights into business operations.</p>
